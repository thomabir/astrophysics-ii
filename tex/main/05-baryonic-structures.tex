...
AGNs are powered by accretion onto a supermassive black hole (SMBH), with masses around \SIrange{e6}{e9}{\solarmass}.
The SMBH grows as it accretes gas, and it can also reinject energy into the IGM in the form of jets.
Accretion can be a very efficient process to convert gravitational energy into radiation.
While most galaxies, including the Milky Way, have an SMBH in their centre, they are not necessarily \emph{active} galaxies.
