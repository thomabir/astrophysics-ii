...
We take moments of the Boltzmann equation. One can show\sidenote{For more details, have a look at \cref{ssec:jeans-equation}.} that one gets the same equations as the fluid equations: the continuity equation and the Euler equation, with the pressure gradient term replaced as follows:
\begin{align*}
	\frac{\Grad_i p}{\rho}
