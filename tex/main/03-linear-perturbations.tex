...
and $b$ is the bias.
The bias depends on the galaxy sample, the scale $k$, and redshif $z$. Fortunately, on large scales, the bias is mostly scale independent.
...
\begin{itemize}
	...
	\item Spectroscopy surveys, such as SDSS, 2DF, and Wiggle-z, measure the position and the redshift of galaxies.
\end{itemize}

% TODO SDSS image
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.7\textwidth]{img/ch-03/spectroscopic-survey.png}
% 	\caption{2dF survey.}
% 	\label{fig:spectroscopic-survey}
% \end{figure}

Some galaxy clusters seem to be stretched in the radial direction, which is caused by their peculiar velocities. This phenomenon is known as redshift space distortions.

% TODO power spectrum galaxies SDSS
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.7\textwidth]{img/ch-03/sdss-power-spectrum.pdf}
% 	\caption{SDSS survey. The redder regions have more galaxies than the green regions.}
% 	\label{fig:sdss-power-spectrum}
% \end{figure}

In \cref{fig:sdss-power-spectrum}, the power spectrum found by the SDSS is shown.
