...
Remember that the CMB gives us a picture of the universe at last scattering, which happened at $z_* \approx \num{1100}$. The spectrum is very close to a blackbody spectrum, with a temperature of $T = \SI{2.728(2)}{\kelvin}$ today.

There are small anisotropies in the CMB temperature with an amplitude of $\Delta T / T \approx \num{e-4}$, as shown in \cref{fig:cmb.png}. We would like to find a model to predict those.

% TODO
% \begin{figure}
% 	\centering
% 	\includegraphics[width=\textwidth]{img/ch-03/cmb.png}
% 	\caption{Anisotropies of the CMB.}
% 	\label{fig:cmb}
% \end{figure}
...
$c_\ell$ has to be computed numerically, which is shown in \cref{fig:c_l}.

% TODO
% \begin{figure}
% 	\centering
% 	\includegraphics[width=\textwidth]{img/ch-03/cl.png}
% 	\caption{The amplitude of the angular power spectrum.}
% 	\label{fig:cl}
% \end{figure}
