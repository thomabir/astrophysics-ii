...
\begin{align*}
	\dv{f}{t}
	= \pdv{f}{t} + \sum_i \pdv{f}{x_i} \pdv{x_i}{t} + \sum_i \pdv{f}{v_i} \pdv{v_i}{t}
	= 0,
\end{align*}
which can be rewritten with $v_i = \pdv*{x_i}{t}$ and $\pdv*{v_i}{t} = - \pdv*{\Phi}{x_i}$ as
\begin{align*}
