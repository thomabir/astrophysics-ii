...
An interesting quantity is the \emph{subhalo mass function}, which describes the number of subhaloes $n$ with mass $m$ in a main halo with total mass $M$.
To make the result independent of the mass of the main halo, we instead use the mass fraction $m/M$.
